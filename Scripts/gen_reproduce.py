...
METHODS_GEN_METHODS = [('rand_gen', 'rand_gen'), ('mir_gen', 'mir_gen')]
METRICS = ['acc']
log = 'off'
...
for dataset in DATASETS:
    ...
    for metric in METRICS:
        ...
        for method, gen_method in METHODS_GEN_METHODS:
            assert(method == gen_method)

            result_dir = "%s_final_%s" % (dataset, method) # will be in Results/
